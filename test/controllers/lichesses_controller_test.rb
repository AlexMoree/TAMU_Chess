...
class LichessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lichess" do
    assert_difference('Lichess.count') do
      post lichesses_url, params: { lichess: { draw: @lichess.draw, loss: @lichess.loss, rank: @lichess.rank, student_id: @lichess.student_id, total_played: @lichess.total_played, username: @lichess.username, win: @lichess.win } }
    end
  ...
  test "should update lichess" do
    patch lichess_url(@lichess), params: { lichess: { draw: @lichess.draw, loss: @lichess.loss, rank: @lichess.rank, student_id: @lichess.student_id, total_played: @lichess.total_played, username: @lichess.username, win: @lichess.win } }
