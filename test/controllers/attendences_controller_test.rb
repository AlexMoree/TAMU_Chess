...
class AttendencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update attendence" do
    patch attendence_url(@attendence), params: { attendence: { attendence: @attendence.attendence, event_date: @attendence.event_date, event_id: @attendence.event_id, event_name: @attendence.event_name } }
